...
var (
	...
	TestnetGenesisHash = common.HexToHash("0x2a386141a768b2f7e1ad839d8e4eec6ef19a41740c51dc9b698369b223c62e25")
)
...
var (
	...
	AllHaptenProtocolChanges = &ChainConfig{big.NewInt(1337), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, nil, &HaptenConfig{Period: 0, Epoch: 30000, AttestationDelay: 2}}
...
type ChainConfig struct {
	...
	Hapten  *HaptenConfig  `json:"hapten,omitempty"`
}
...
// HaptenConfig is the consensus engine configs for proof-of-stake-authority based sealing.
type HaptenConfig struct {
	Period uint64 `json:"period"` // Number of seconds between blocks to enforce
	Epoch  uint64 `json:"epoch"`  // Epoch length to reset votes and checkpoint
...
// String implements the stringer interface, returning the consensus engine details.
func (c *HaptenConfig) String() string {
	return "hapten"
}
...
func (c *ChainConfig) HaptenContinuousInturn(blockNumber *big.Int) uint64 {
