...
// checkpoint creates a Hapten checkpoint signer section from the provided list
...
// sign calculates a Hapten digital signature for the given block and embeds it
...
func TestHapten(t *testing.T) {
	...
	for i, tt := range tests {
		...
		// hapten need the chain for extra_validate feature
