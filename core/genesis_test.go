...
func TestGenesisUnmarshal(t *testing.T) {
	...
	assert.Equal(t, genesis.configOrDefault(common.Hash{}).Hapten,
		&params.HaptenConfig{Period: 3, Epoch: 200, AttestationDelay: 2})

	stakingInit := genesis.Alloc[system.StakingContract].Init
	assert.Equal(t, stakingInit, &Init{
		Admin:           common.HexToAddress("0x07Ff2F6e4bDA2a899F71735C7071F061D0bb3647"),
	...
	assert.Equal(t, genesis.Validators[0], ValidatorInfo{
		Address:          common.HexToAddress("0xC8F660906B413027000e583E00a5ea0008370755"),
		Manager:          common.HexToAddress("0x07Ff2F6e4bDA2a899F71735C7071F061D0bb3647"),
		Rate:             big.NewInt(20),
		Stake:            big.NewInt(350000),
		AcceptDelegation: true,
	})

	eoa := genesis.Alloc[common.HexToAddress("0x07Ff2F6e4bDA2a899F71735C7071F061D0bb3647")]
